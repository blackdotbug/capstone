...
function plotAllTraining() {
  ...
  d3.json('/api/sexism').then(data => {
    ...
    let gSource = divSource.append('svg').attr('width', widthSource).attr('height', heightSource).append('g').attr('transform', `translate(${marginSource.left}, ${marginSource.top})`)
    ...
    let marginEdits = 30
    let svgEdits = divEdited.append('svg').attr('width', widthEdits).attr('height', heightEdits)
    ...
    let marginSexist = 30
    let svgSexist = divSexist.append('svg').attr('width', widthSexist).attr('height', heightSexist)
...
function plotAllReddit() {
  ...
  d3.json('/api/redditcomments').then(data => {
    ...
    let gPredictions = divPredictions.append('svg').attr('width', widthPredictions).attr('height', heightPredictions).append('g').attr('transform', `translate(${marginPredictions.left},${marginPredictions.top})`)
    ...
    let gVotes = divVotes.append('svg').attr('width', widthVotes).attr('height', heightVotes).append('g').attr('transform', `translate(${marginVotes.left},${marginVotes.top})`)
...
d3.select(window).on('resize', plotAllTraining);
plotAllTraining();
d3.select(window).on('resize', plotAllReddit);
plotAllReddit();
